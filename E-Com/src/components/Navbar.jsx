...
const Navbar = () => {
  ...
  <div className="container mx-auto flex justify-between items-center p-4">
    {/* Brand Name */}
    <div className="text-2xl font-extrabold tracking-wide">E-COM</div>
  ...
  {/* Dropdown Menu */}
  {isOpen && (
    <div className="absolute top-full left-0 w-full bg-blue-500 bg-opacity-95 text-white flex flex-col items-center z-50 min-w-full">
      {/* Close Button */}
      <button
